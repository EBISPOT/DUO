...
- Satoshi Nagaie (ToMMo, GEM Japan)
- Minae Kawashima (NBDC, GEM Japan)
- Chihiro Hata (DDBJ, GEM Japan)
- Shuichi Kawashima (DBCLS, GEM Japan)
- Yuichi Kodama (DDBJ, GEM Japan)
- Mizuki Morita (Okayama Univ., GEM Japan)
- Natsuko Yamamoto (Osaka Univ., GEM Japan)
- Akio Nagano (PENQE inc., GEM Japan)
- Keiko Katsui (AMED, GEM Japan)
- Takako Takai (AMED, GEM Japan)
